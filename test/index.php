...
<body>
    ...
    <form class="container" action="login.php" method="post">
        ...
        <p><?php echo $lang == 'en' ? 'Not a member?' : 'لست عضوا؟'; ?> <a href="register.php"><?php echo $lang == 'en' ? 'Register here' : 'سجل هنا'; ?></a>.</p>
    </form>
    <script>
        ...
        if(urlParams.has('register') && urlParams.get('register') === 'success') {
            alert('<?php echo $lang == 'en' ? 'Registration successful' : 'تم التسجيل بنجاح'; ?>');
        }
    </script>
